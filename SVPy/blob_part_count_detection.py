...
def displayFrame(frame, detections):
    for detection in detections:
        ...
        (255, 0, 0), 2)
        cv2.putText(frame, f"{detection.Label} {int(detection.Score)}%", (int(detection.Box.Left * 480) + 80 + 10, int(detection.Box.Top * 480) + 20), cv2.FONT_HERSHEY_SIMPLEX, 0.75, 255, thickness=2)
